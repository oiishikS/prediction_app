      ...
      <main className="mx-auto flex min-h-[calc(100vh-4rem)] w-full max-w-5xl items-center justify-center">
        <section className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-[var(--color-brand-surface)] p-6 shadow-[0_22px_48px_-20px_rgba(47,27,87,0.45),0_14px_24px_-16px_rgba(47,27,87,0.35)] ring-1 ring-white/70 sm:p-10">
          ...
          <div className="relative mt-8 grid gap-4 md:grid-cols-2">
            <section className="rounded-2xl border border-[color-mix(in_oklab,var(--color-brand-ink),white_78%)] bg-white p-5 shadow-[0_14px_24px_-18px_rgba(47,27,87,0.65),0_6px_10px_-8px_rgba(47,27,87,0.35)]">
            ...
            <section className="rounded-2xl bg-[linear-gradient(145deg,var(--color-brand-primary),color-mix(in_oklab,var(--color-brand-primary),black_14%))] p-5 shadow-[0_16px_28px_-18px_rgba(47,27,87,0.78),0_8px_12px_-10px_rgba(47,27,87,0.5)]">
          ...
          <section className="relative mt-4 rounded-2xl border border-[color-mix(in_oklab,var(--color-brand-accent),white_55%)] bg-[linear-gradient(145deg,color-mix(in_oklab,var(--color-brand-accent),white_78%),white)] p-5 shadow-[0_16px_26px_-18px_rgba(19,126,112,0.6),0_6px_10px_-8px_rgba(19,126,112,0.35)]">
